...
public class DEPRECATED_MainActivity extends AppCompatActivity {
    private static final String TAG = "DEPRECATED_MainActivity";
...
//            TextView text = DEPRECATED_MainActivity.this.findViewById(R.id.outputText);
